    ...
    class RelationTest {
        ...
        void shouldThrowExceptionWhenFromIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new Relation(null, new EntityId("to"), new RelationType("rel")));
        }

        @Test
        void shouldThrowExceptionWhenToIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new Relation(new EntityId("from"), null, new RelationType("rel")));
        }

        @Test
        void shouldThrowExceptionWhenRelationTypeIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new Relation(new EntityId("from"), new EntityId("to"), null));
        }
    }
}
